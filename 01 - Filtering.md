...
The pdf files presented here are not accessible in the dataset for
copyright reasons.
...
The collected information on the corpus can be found as a
`export_data.txt` and `Pre-process.RData` files.
